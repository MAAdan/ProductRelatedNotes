...
* A Product Manager should consider providing templates that structure new ideas to people. This is called Product Requirement Document (PRD). Here's an example that can be used for such template:
  * Product idea:
  * Which of our users (current or perspective) this is for Colin.
...
* Prioritisation is where organisational goals and turn into actual decisions about timing and resource allocation. See: ![Impact-vs-effort-matrix](Impact-vs-effort-matrix.png)
*  The use of a Impact-Versus-Effort Matrix helps with the prioritisation process
